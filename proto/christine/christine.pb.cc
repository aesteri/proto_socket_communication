...
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_proto_2fchristine_2fchristine_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_proto_2fchristine_2fchristine_2eproto = nullptr;
const ::uint32_t TableStruct_proto_2fchristine_2fchristine_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
static ::absl::once_flag descriptor_table_proto_2fchristine_2fchristine_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_proto_2fchristine_2fchristine_2eproto = {
    false,
    false,
    100,
    descriptor_table_protodef_proto_2fchristine_2fchristine_2eproto,
    "proto/christine/christine.proto",
    &descriptor_table_proto_2fchristine_2fchristine_2eproto_once,
    nullptr,
    0,
    1,
    schemas,
    file_default_instances,
    TableStruct_proto_2fchristine_2fchristine_2eproto::offsets,
    file_level_metadata_proto_2fchristine_2fchristine_2eproto,
    file_level_enum_descriptors_proto_2fchristine_2fchristine_2eproto,
...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_proto_2fchristine_2fchristine_2eproto(&descriptor_table_proto_2fchristine_2fchristine_2eproto);
namespace christine {
// ===================================================================
...
const ::_pbi::TcParseTable<1, 2, 0, 43, 2> Client::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    {::_pbi::TcParser::FastUS1,
     {18, 63, 0, PROTOBUF_FIELD_OFFSET(Client, _impl_.message_)}},
    // string sender_name = 1;
    {::_pbi::TcParser::FastUS1,
     {10, 63, 0, PROTOBUF_FIELD_OFFSET(Client, _impl_.sender_name_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string sender_name = 1;
    {PROTOBUF_FIELD_OFFSET(Client, _impl_.sender_name_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // string message = 2;
    {PROTOBUF_FIELD_OFFSET(Client, _impl_.message_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
...
::uint8_t* Client::_InternalSerialize(
  ...
  if (!this->_internal_sender_name().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "christine.Client.sender_name");
  ...
  if (!this->_internal_message().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "christine.Client.message");
